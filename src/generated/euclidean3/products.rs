...
pub fn sandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        v.s() * x.y() * v.xy() - v.yz() * x.y() * v.xz()
            ...
            - v.xz() * x.y() * v.yz()
            + v.yz() * x.x() * v.yz(),
        -(v.xy() * x.x() * v.s()) - v.yz() * x.x() * v.xz() + v.xz() * x.y() * v.xz()
            - v.xz() * x.x() * v.yz()
            + v.s() * x.z() * v.yz()
            - v.xy() * x.z() * v.xz()
            + v.s() * x.y() * v.s()
            ...
            - v.xy() * x.y() * v.xy()
            - v.xz() * x.z() * v.xy(),
        -(v.s() * x.y() * v.yz()) - v.yz() * x.y() * v.s() - v.yz() * x.z() * v.yz()
            + v.yz() * x.x() * v.xy()
            + v.xy() * x.z() * v.xy()
            + v.xy() * x.x() * v.yz()
            - v.xy() * x.y() * v.xz()
...
pub fn sandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        v.xy() * x.yz() * v.yz() + v.s() * x.xz() * v.yz() - v.yz() * x.xy() * v.yz()
            + v.yz() * x.xz() * v.s()
            + v.yz() * x.yz() * v.xy()
            + v.xy() * x.xz() * v.xz()
            - v.xz() * x.yz() * v.s()
...
pub fn sandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new_unchecked(
        ...
        v.xz() * x.yz() * v.yz() - v.yz() * x.xz() * v.yz()
            ...
            - v.xy() * x.xz() * v.xy()
            + v.s() * x.xz() * v.s(),
        -(v.xz() * x.yz() * v.xz()) + v.xy() * x.s() * v.xz() + v.xy() * x.xy() * v.yz()
            - v.s() * x.s() * v.yz()
            + v.s() * x.xy() * v.xz()
            - v.xy() * x.yz() * v.xy()
            + v.xz() * x.xy() * v.s()
...
pub fn antisandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        v.yz() * x.x() * v.yz() - v.s() * x.z() * v.xz() - v.xz() * x.z() * v.s()
            + v.s() * x.x() * v.s()
            - v.xz() * x.y() * v.yz()
            - v.s() * x.y() * v.xy()
            + v.yz() * x.z() * v.xy()
        ...
        -(v.xz() * x.x() * v.yz())
            ...
            - v.yz() * x.y() * v.yz()
            - v.xy() * x.z() * v.xz(),
        v.s() * x.x() * v.xz() + v.s() * x.z() * v.s() + v.xy() * x.z() * v.xy()
            - v.xy() * x.y() * v.xz()
            - v.xz() * x.y() * v.xy()
            + v.yz() * x.y() * v.s()
            - v.xz() * x.z() * v.xz()
...
pub fn antisandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new_unchecked(
        v.xz() * x.yz() * v.xy() + v.xy() * x.s() * v.xy() + v.s() * x.s() * v.s()
            - v.xy() * x.xy() * v.s()
            - v.xy() * x.yz() * v.xz()
            + v.s() * x.xy() * v.xy()
            - v.xz() * x.xy() * v.yz()
            ...
            + v.s() * x.yz() * v.yz()
            + v.yz() * x.xy() * v.xz(),
        v.s() * x.xy() * v.s() - v.yz() * x.xz() * v.s() - v.s() * x.s() * v.xy()
            + v.s() * x.yz() * v.xz()
            + v.xz() * x.xz() * v.xy()
            + v.xy() * x.xy() * v.xy()
            + v.xy() * x.xz() * v.xz()
            ...
            + v.xz() * x.yz() * v.s()
            + v.yz() * x.s() * v.xz(),
        v.s() * x.xz() * v.s() + v.xy() * x.s() * v.yz() - v.xy() * x.xz() * v.xy()
            + v.yz() * x.yz() * v.xz()
            - v.xy() * x.yz() * v.s()
            + v.xz() * x.xz() * v.xz()
            - v.s() * x.s() * v.xz()
