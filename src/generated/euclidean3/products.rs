...
pub fn exterior_scalar_vector<T: Float>(a: &Scalar<T>, b: &Vector<T>) -> Vector<T> {
    Vector::new(b.x() * a.s(), b.y() * a.s(), b.z() * a.s())
}
...
pub fn interior_rotor_vector<T: Float>(a: &Rotor<T>, b: &Vector<T>) -> Vector<T> {
    Vector::new(
        a.xy() * b.y() + a.xz() * b.z() + b.x() * a.s(),
        -(a.xy() * b.x()) + a.yz() * b.z() + b.y() * a.s(),
        -(a.xz() * b.x()) + -(a.yz() * b.y()) + b.z() * a.s(),
    )
}
...
pub fn interior_vector_rotor<T: Float>(a: &Vector<T>, b: &Rotor<T>) -> Vector<T> {
    Vector::new(
        b.s() * a.x() + -(b.xy() * a.y()) + -(b.xz() * a.z()),
        b.s() * a.y() + b.xy() * a.x() + -(b.yz() * a.z()),
        b.s() * a.z() + b.xz() * a.x() + b.yz() * a.y(),
    )
}
...
#[doc = "Dot product: Trivector • Trivector -> T (same-grade metric inner)"]
#[inline]
pub fn dot_trivector_trivector<T: Float>(a: &Trivector<T>, b: &Trivector<T>) -> T {
    -(a.xyz() * b.xyz())
}
...
pub fn sandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        -(v.xy() * x.x() * v.xy()) + v.yz() * x.x() * v.yz() + v.xy() * x.z() * v.yz()
            - v.xz() * x.y() * v.yz()
            - v.xz() * x.x() * v.xz()
            + v.s() * x.z() * v.xz()
            - v.yz() * x.y() * v.xz()
            ...
            + v.s() * x.y() * v.xy()
            + v.xy() * x.y() * v.s(),
        -(v.xy() * x.x() * v.s()) - v.xy() * x.z() * v.xz() + v.yz() * x.z() * v.s()
            - v.yz() * x.x() * v.xz()
            - v.s() * x.x() * v.xy()
            - v.xz() * x.x() * v.yz()
            - v.xz() * x.z() * v.xy()
            ...
            - v.yz() * x.y() * v.yz()
            + v.xz() * x.y() * v.xz(),
        -(v.yz() * x.y() * v.s()) + v.yz() * x.x() * v.xy() + v.xy() * x.z() * v.xy()
            - v.xz() * x.z() * v.xz()
            - v.xz() * x.x() * v.s()
            + v.s() * x.z() * v.s()
            - v.s() * x.y() * v.yz()
...
pub fn sandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        ...
        -(v.yz() * x.xy() * v.s())
            ...
            - v.yz() * x.xz() * v.yz()
            + v.s() * x.yz() * v.xy(),
        v.xz() * x.xy() * v.s() + v.yz() * x.xy() * v.xy() - v.xy() * x.xz() * v.s()
            + v.xy() * x.xy() * v.yz()
            - v.s() * x.xz() * v.xy()
            - v.xy() * x.yz() * v.xy()
            - v.xz() * x.yz() * v.xz()
...
pub fn sandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        -(v.yz() * x.xy() * v.xz()) + v.s() * x.xz() * v.xz() + v.xy() * x.yz() * v.xz()
            - v.xz() * x.xz() * v.s()
            + v.yz() * x.s() * v.yz()
            - v.xy() * x.xy() * v.s()
            + v.s() * x.xy() * v.xy()
        ...
        v.yz() * x.yz() * v.xy()
            ...
            + v.yz() * x.xz() * v.s()
            - v.xz() * x.yz() * v.s(),
        v.xz() * x.s() * v.s() + v.yz() * x.yz() * v.xz() + v.xz() * x.xy() * v.xy()
            - v.yz() * x.xy() * v.s()
            + v.xy() * x.xy() * v.xz()
            - v.s() * x.s() * v.xz()
            + v.s() * x.yz() * v.xy()
...
pub fn antisandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        -(v.xz() * x.x() * v.xz())
            ...
            + v.yz() * x.z() * v.xy()
            - v.xz() * x.z() * v.s(),
        -(v.yz() * x.y() * v.yz()) - v.yz() * x.z() * v.s() - v.xy() * x.z() * v.xz()
            + v.xz() * x.y() * v.xz()
            - v.xy() * x.y() * v.xy()
            - v.xz() * x.z() * v.xy()
            - v.yz() * x.x() * v.xz()
            ...
            - v.s() * x.z() * v.yz()
            + v.s() * x.x() * v.xy(),
        v.xy() * x.z() * v.xy() + v.s() * x.y() * v.yz() - v.xz() * x.z() * v.xz()
            + v.s() * x.z() * v.s()
            + v.xz() * x.x() * v.s()
            + v.s() * x.x() * v.xz()
            + v.yz() * x.y() * v.s()
...
pub fn antisandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        ...
        -(v.yz() * x.xz() * v.yz()) + v.s() * x.xz() * v.s()
            ...
            + v.xy() * x.xy() * v.xz()
            + v.s() * x.xy() * v.yz(),
        v.xy() * x.xz() * v.s() - v.xy() * x.yz() * v.xy() + v.xz() * x.xz() * v.yz()
            - v.s() * x.xy() * v.xz()
            + v.s() * x.yz() * v.s()
            + v.s() * x.xz() * v.xy()
            - v.xz() * x.yz() * v.xz()
...
pub fn antisandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        v.s() * x.yz() * v.yz() + v.s() * x.xz() * v.xz() + v.xy() * x.s() * v.xy()
            - v.xz() * x.xz() * v.s()
            + v.yz() * x.s() * v.yz()
            + v.s() * x.s() * v.s()
            - v.xz() * x.xy() * v.yz()
        ...
        v.s() * x.xy() * v.s()
            ...
            + v.xz() * x.yz() * v.s()
            - v.yz() * x.xy() * v.yz(),
        v.xz() * x.xy() * v.xy() - v.yz() * x.xz() * v.yz() - v.yz() * x.s() * v.xy()
            + v.xy() * x.s() * v.yz()
            - v.xy() * x.yz() * v.s()
            + v.s() * x.xz() * v.s()
            + v.xy() * x.xy() * v.xz()
            ...
            + v.yz() * x.xy() * v.s()
            + v.xz() * x.s() * v.s(),
        v.yz() * x.s() * v.s() + v.yz() * x.xz() * v.xz() - v.xy() * x.yz() * v.xy()
            + v.xz() * x.xz() * v.yz()
            + v.yz() * x.xy() * v.xy()
            + v.s() * x.yz() * v.s()
            + v.s() * x.xz() * v.xy()
