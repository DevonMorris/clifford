...
pub fn sandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        v.yz() * x.x() * v.yz() + v.xz() * x.z() * v.s() - v.yz() * x.y() * v.xz()
            + v.s() * x.x() * v.s()
            - v.xz() * x.y() * v.yz()
            + v.s() * x.z() * v.xz()
            + v.xy() * x.y() * v.s()
            ...
            - v.xy() * x.x() * v.xy()
            + v.xy() * x.z() * v.yz(),
        v.s() * x.y() * v.s() - v.yz() * x.x() * v.xz() + v.s() * x.z() * v.yz()
            - v.yz() * x.y() * v.yz()
            - v.xy() * x.x() * v.s()
            - v.xy() * x.z() * v.xz()
            + v.xz() * x.y() * v.xz()
            ...
            - v.xz() * x.x() * v.yz()
            - v.s() * x.x() * v.xy(),
        -(v.xz() * x.y() * v.xy()) - v.xz() * x.x() * v.s() + v.xy() * x.z() * v.xy()
            - v.xy() * x.y() * v.xz()
            - v.s() * x.x() * v.xz()
            - v.yz() * x.y() * v.s()
            - v.yz() * x.z() * v.yz()
...
pub fn sandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        v.s() * x.xz() * v.yz() + v.s() * x.xy() * v.s() - v.xz() * x.xy() * v.xz()
            + v.xz() * x.xz() * v.xy()
            - v.s() * x.yz() * v.xz()
            + v.xy() * x.yz() * v.yz()
            + v.xy() * x.xy() * v.xy()
            ...
            + v.yz() * x.yz() * v.xy()
            - v.yz() * x.xy() * v.yz(),
        v.xz() * x.yz() * v.yz() - v.yz() * x.xy() * v.s() + v.yz() * x.yz() * v.xz()
            - v.s() * x.xy() * v.yz()
            + v.xz() * x.xz() * v.xz()
            + v.s() * x.yz() * v.xy()
            - v.xy() * x.xz() * v.xy()
...
pub fn sandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new_unchecked(
        -(v.xz() * x.yz() * v.xy()) + v.xz() * x.s() * v.xz() + v.xy() * x.yz() * v.xz()
            - v.yz() * x.yz() * v.s()
            + v.s() * x.s() * v.s()
            + v.yz() * x.xz() * v.xy()
            - v.xy() * x.xz() * v.yz()
            ...
            + v.xz() * x.xy() * v.yz()
            + v.xy() * x.s() * v.xy(),
        v.xy() * x.xz() * v.xz() + v.xz() * x.xz() * v.xy() + v.xy() * x.s() * v.s()
            - v.xz() * x.yz() * v.s()
            + v.xy() * x.xy() * v.xy()
            + v.yz() * x.xz() * v.s()
            - v.yz() * x.xy() * v.yz()
        ...
        v.yz() * x.yz() * v.xz()
            ...
            - v.s() * x.s() * v.xz()
            + v.s() * x.yz() * v.xy(),
        v.xz() * x.xz() * v.yz() + v.s() * x.xy() * v.xz() + v.xy() * x.s() * v.xz()
            - v.xy() * x.yz() * v.xy()
            - v.s() * x.xz() * v.xy()
            - v.xy() * x.xz() * v.s()
            + v.yz() * x.s() * v.s()
...
pub fn antisandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        ...
        v.xy() * x.x() * v.s()
            ...
            - v.yz() * x.x() * v.xz()
            + v.s() * x.x() * v.xy(),
        v.yz() * x.x() * v.xy() + v.xz() * x.x() * v.s() + v.yz() * x.y() * v.s()
            - v.yz() * x.z() * v.yz()
            + v.s() * x.x() * v.xz()
            - v.xy() * x.y() * v.xz()
            - v.xz() * x.y() * v.xy()
...
pub fn antisandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        v.xy() * x.yz() * v.yz() + v.xz() * x.xz() * v.xy() + v.xz() * x.yz() * v.s()
            - v.yz() * x.xy() * v.yz()
            - v.xz() * x.xy() * v.xz()
            + v.xy() * x.xy() * v.xy()
            + v.s() * x.yz() * v.xz()
            ...
            - v.yz() * x.xz() * v.s()
            + v.yz() * x.yz() * v.xy(),
        -(v.xy() * x.xz() * v.xy()) - v.s() * x.yz() * v.xy() + v.s() * x.xz() * v.s()
            - v.xy() * x.yz() * v.s()
            + v.yz() * x.xy() * v.s()
            + v.xz() * x.yz() * v.yz()
            + v.xz() * x.xz() * v.xz()
...
pub fn antisandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new_unchecked(
        v.s() * x.xz() * v.xz() + v.yz() * x.s() * v.yz() + v.xz() * x.s() * v.xz()
            - v.yz() * x.xz() * v.xy()
            + v.s() * x.s() * v.s()
            + v.s() * x.yz() * v.yz()
            + v.s() * x.xy() * v.xy()
        ...
        -(v.yz() * x.s() * v.xy()) - v.xy() * x.xz() * v.xy()
            ...
            + v.yz() * x.yz() * v.xz()
            - v.xy() * x.yz() * v.s(),
        v.xz() * x.xz() * v.yz() + v.s() * x.xz() * v.xy() - v.xy() * x.s() * v.xz()
            + v.yz() * x.s() * v.s()
            + v.yz() * x.xz() * v.xz()
            + v.xy() * x.xz() * v.s()
            + v.yz() * x.xy() * v.xy()
...
pub fn reverse_rotor<T: Float>(a: &Rotor<T>) -> Rotor<T> {
    Rotor::new_unchecked(a.s(), -a.xy(), -a.xz(), -a.yz())
}
