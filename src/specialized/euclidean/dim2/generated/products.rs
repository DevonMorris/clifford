...
#[doc = "Antigeometric product: Bivector ⊛ Bivector -> Bivector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_bivector_bivector<T: Float>(a: &Bivector<T>, b: &Bivector<T>) -> Bivector<T> {
    Bivector::new(a.xy() * b.xy())
}
#[doc = "Antigeometric product: Bivector ⊛ Rotor -> Rotor\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_bivector_rotor<T: Float>(a: &Bivector<T>, b: &Rotor<T>) -> Rotor<T> {
    Rotor::new(a.xy() * b.s(), a.xy() * b.xy())
}
#[doc = "Antigeometric product: Bivector ⊛ Scalar -> Scalar\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_bivector_scalar<T: Float>(a: &Bivector<T>, b: &Scalar<T>) -> Scalar<T> {
    Scalar::new(a.xy() * b.s())
}
#[doc = "Antigeometric product: Bivector ⊛ Vector -> Vector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_bivector_vector<T: Float>(a: &Bivector<T>, b: &Vector<T>) -> Vector<T> {
    Vector::new(-(a.xy() * b.x()), -(a.xy() * b.y()))
}
#[doc = "Antigeometric product: Rotor ⊛ Bivector -> Rotor\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_rotor_bivector<T: Float>(a: &Rotor<T>, b: &Bivector<T>) -> Rotor<T> {
    Rotor::new(a.s() * b.xy(), a.xy() * b.xy())
}
#[doc = "Antigeometric product: Rotor ⊛ Rotor -> Rotor\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_rotor_rotor<T: Float>(a: &Rotor<T>, b: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        a.s() * b.xy() + a.xy() * b.s(),
        -(a.s() * b.s()) + a.xy() * b.xy(),
    )
}
#[doc = "Antigeometric product: Rotor ⊛ Scalar -> Rotor\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_rotor_scalar<T: Float>(a: &Rotor<T>, b: &Scalar<T>) -> Rotor<T> {
    Rotor::new(a.xy() * b.s(), -(a.s() * b.s()))
}
#[doc = "Antigeometric product: Rotor ⊛ Vector -> Vector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_rotor_vector<T: Float>(a: &Rotor<T>, b: &Vector<T>) -> Vector<T> {
    Vector::new(
        -(a.s() * b.y()) - a.xy() * b.x(),
        a.s() * b.x() - a.xy() * b.y(),
    )
}
#[doc = "Antigeometric product: Scalar ⊛ Bivector -> Scalar\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_scalar_bivector<T: Float>(a: &Scalar<T>, b: &Bivector<T>) -> Scalar<T> {
    Scalar::new(a.s() * b.xy())
}
#[doc = "Antigeometric product: Scalar ⊛ Rotor -> Rotor\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_scalar_rotor<T: Float>(a: &Scalar<T>, b: &Rotor<T>) -> Rotor<T> {
    Rotor::new(a.s() * b.xy(), -(a.s() * b.s()))
}
#[doc = "Antigeometric product: Scalar ⊛ Scalar -> Bivector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_scalar_scalar<T: Float>(a: &Scalar<T>, b: &Scalar<T>) -> Bivector<T> {
    Bivector::new(-(a.s() * b.s()))
}
#[doc = "Antigeometric product: Scalar ⊛ Vector -> Vector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_scalar_vector<T: Float>(a: &Scalar<T>, b: &Vector<T>) -> Vector<T> {
    Vector::new(-(a.s() * b.y()), a.s() * b.x())
}
#[doc = "Antigeometric product: Vector ⊛ Bivector -> Vector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_vector_bivector<T: Float>(a: &Vector<T>, b: &Bivector<T>) -> Vector<T> {
    Vector::new(-(a.x() * b.xy()), -(a.y() * b.xy()))
}
#[doc = "Antigeometric product: Vector ⊛ Rotor -> Vector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_vector_rotor<T: Float>(a: &Vector<T>, b: &Rotor<T>) -> Vector<T> {
    Vector::new(
        -(a.x() * b.xy()) + a.y() * b.s(),
        -(a.x() * b.s()) - a.y() * b.xy(),
    )
}
#[doc = "Antigeometric product: Vector ⊛ Scalar -> Vector\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
pub fn antigeometric_vector_scalar<T: Float>(a: &Vector<T>, b: &Scalar<T>) -> Vector<T> {
    Vector::new(a.y() * b.s(), -(a.x() * b.s()))
}
#[doc = "Antigeometric product: Vector ⊛ Vector -> Rotor\n\nDefined as complement(complement(a) * complement(b))."]
#[inline]
...
pub fn sandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        v.s() * x.s() * v.s() + v.xy() * x.s() * v.xy() + v.s() * x.xy() * v.xy()
            - v.xy() * x.xy() * v.s(),
        v.xy() * x.xy() * v.xy() + v.s() * x.xy() * v.s() - v.s() * x.s() * v.xy()
            + v.xy() * x.s() * v.s(),
    )
}
...
pub fn antisandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        v.xy() * x.s() * v.xy() + v.s() * x.xy() * v.xy() + v.s() * x.s() * v.s()
            - v.xy() * x.xy() * v.s(),
        -(v.s() * x.s() * v.xy())
            + v.s() * x.xy() * v.s()
            + v.xy() * x.xy() * v.xy()
