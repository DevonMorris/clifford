...
impl<T: Float> BitXor<Vector<T>> for Rotor<T> {
    ...
    fn bitxor(self, rhs: Vector<T>) -> Vector<T> {
        exterior_rotor_vector(&self, &rhs)
    }
}
...
impl<T: Float> BitXor<Rotor<T>> for Vector<T> {
    ...
    fn bitxor(self, rhs: Rotor<T>) -> Vector<T> {
        exterior_vector_rotor(&self, &rhs)
    }
}
...
impl<T: Float> GeometricProduct<Bivector<T>> for Bivector<T> {
    type Output = Scalar<T>;
    #[inline]
    fn geometric(&self, rhs: &Bivector<T>) -> Scalar<T> {
        geometric_bivector_bivector(self, rhs)
    }
}
...
impl<T: Float> GeometricProduct<Vector<T>> for Bivector<T> {
    type Output = Vector<T>;
    #[inline]
...
impl<T: Float> GeometricProduct<Vector<T>> for Rotor<T> {
    type Output = Vector<T>;
    #[inline]
    fn geometric(&self, rhs: &Vector<T>) -> Vector<T> {
        geometric_rotor_vector(self, rhs)
...
impl<T: Float> GeometricProduct<Bivector<T>> for Vector<T> {
    type Output = Vector<T>;
    #[inline]
...
impl<T: Float> GeometricProduct<Rotor<T>> for Vector<T> {
    type Output = Vector<T>;
    #[inline]
    fn geometric(&self, rhs: &Rotor<T>) -> Vector<T> {
        geometric_vector_rotor(self, rhs)
    }
}
...
impl<T: Float> Wedge<Vector<T>> for Rotor<T> {
    type Output = Vector<T>;
    #[inline]
...
impl<T: Float> Wedge<Rotor<T>> for Vector<T> {
    type Output = Vector<T>;
    #[inline]
    fn wedge(&self, rhs: &Rotor<T>) -> Vector<T> {
        exterior_vector_rotor(self, rhs)
    }
}
...
impl<T: Float> Antiwedge<Scalar<T>> for Bivector<T> {
    ...
    fn antiwedge(&self, rhs: &Scalar<T>) -> Scalar<T> {
        regressive_bivector_scalar(self, rhs)
    }
}
...
impl<T: Float> Antiwedge<Bivector<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antiwedge(&self, rhs: &Bivector<T>) -> Rotor<T> {
...
impl<T: Float> Antiwedge<Scalar<T>> for Rotor<T> {
    type Output = Scalar<T>;
    #[inline]
    fn antiwedge(&self, rhs: &Scalar<T>) -> Scalar<T> {
        regressive_rotor_scalar(self, rhs)
    }
}
...
impl<T: Float> Antiwedge<Bivector<T>> for Scalar<T> {
    ...
    fn antiwedge(&self, rhs: &Bivector<T>) -> Scalar<T> {
        regressive_scalar_bivector(self, rhs)
    }
}
impl<T: Float> Antiwedge<Rotor<T>> for Scalar<T> {
    type Output = Scalar<T>;
    #[inline]
    fn antiwedge(&self, rhs: &Rotor<T>) -> Scalar<T> {
        regressive_scalar_rotor(self, rhs)
    }
}
...
impl<T: Float> Antiwedge<Vector<T>> for Vector<T> {
    ...
    fn antiwedge(&self, rhs: &Vector<T>) -> Scalar<T> {
        regressive_vector_vector(self, rhs)
    }
}
...
impl<T: Float> BulkExpand<Bivector<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn bulk_expand(&self, rhs: &Bivector<T>) -> Rotor<T> {
        bulk_expansion_rotor_bivector(self, rhs)
    }
}
impl<T: Float> BulkExpand<Rotor<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn bulk_expand(&self, rhs: &Rotor<T>) -> Rotor<T> {
        bulk_expansion_rotor_rotor(self, rhs)
    }
}
...
impl<T: Float> BulkExpand<Rotor<T>> for Scalar<T> {
    type Output = Rotor<T>;
    #[inline]
    fn bulk_expand(&self, rhs: &Rotor<T>) -> Rotor<T> {
        bulk_expansion_scalar_rotor(self, rhs)
    }
}
...
impl<T: Float> BulkExpand<Rotor<T>> for Vector<T> {
    type Output = Vector<T>;
    #[inline]
    fn bulk_expand(&self, rhs: &Rotor<T>) -> Vector<T> {
...
impl<T: Float> WeightExpand<Bivector<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn weight_expand(&self, rhs: &Bivector<T>) -> Rotor<T> {
        weight_expansion_rotor_bivector(self, rhs)
    }
}
impl<T: Float> WeightExpand<Rotor<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn weight_expand(&self, rhs: &Rotor<T>) -> Rotor<T> {
        weight_expansion_rotor_rotor(self, rhs)
    }
}
...
impl<T: Float> WeightExpand<Rotor<T>> for Scalar<T> {
    type Output = Rotor<T>;
    #[inline]
    fn weight_expand(&self, rhs: &Rotor<T>) -> Rotor<T> {
        weight_expansion_scalar_rotor(self, rhs)
    }
}
...
impl<T: Float> WeightExpand<Rotor<T>> for Vector<T> {
    type Output = Vector<T>;
    #[inline]
    fn weight_expand(&self, rhs: &Rotor<T>) -> Vector<T> {
...
impl<T: Float> Antigeometric<Bivector<T>> for Bivector<T> {
    type Output = Bivector<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Bivector<T>) -> Bivector<T> {
        antigeometric_bivector_bivector(self, rhs)
    }
}
impl<T: Float> Antigeometric<Rotor<T>> for Bivector<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Rotor<T>) -> Rotor<T> {
        antigeometric_bivector_rotor(self, rhs)
    }
}
...
impl<T: Float> Antigeometric<Bivector<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Bivector<T>) -> Rotor<T> {
        antigeometric_rotor_bivector(self, rhs)
    }
}
impl<T: Float> Antigeometric<Rotor<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Rotor<T>) -> Rotor<T> {
        antigeometric_rotor_rotor(self, rhs)
    }
}
impl<T: Float> Antigeometric<Scalar<T>> for Rotor<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Scalar<T>) -> Rotor<T> {
        antigeometric_rotor_scalar(self, rhs)
    }
}
...
impl<T: Float> Antigeometric<Bivector<T>> for Scalar<T> {
    type Output = Scalar<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Bivector<T>) -> Scalar<T> {
        antigeometric_scalar_bivector(self, rhs)
    }
}
impl<T: Float> Antigeometric<Rotor<T>> for Scalar<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Rotor<T>) -> Rotor<T> {
        antigeometric_scalar_rotor(self, rhs)
    }
}
...
impl<T: Float> Antigeometric<Rotor<T>> for Vector<T> {
    type Output = Vector<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Rotor<T>) -> Vector<T> {
...
impl<T: Float> Antigeometric<Vector<T>> for Vector<T> {
    type Output = Rotor<T>;
    #[inline]
    fn antigeometric(&self, rhs: &Vector<T>) -> Rotor<T> {
        antigeometric_vector_vector(self, rhs)
    }
}
