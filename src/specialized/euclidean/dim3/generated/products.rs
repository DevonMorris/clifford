...
pub fn sandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        v.xz() * x.z() * v.s() + v.yz() * x.x() * v.yz() - v.xz() * x.y() * v.yz()
            + v.yz() * x.z() * v.xy()
            - v.yz() * x.y() * v.xz()
            + v.s() * x.x() * v.s()
            - v.xy() * x.x() * v.xy()
            ...
            - v.xz() * x.x() * v.xz()
            + v.s() * x.z() * v.xz(),
        -(v.xz() * x.z() * v.xy()) + v.yz() * x.z() * v.s() + v.xz() * x.y() * v.xz()
            - v.yz() * x.y() * v.yz()
            - v.s() * x.x() * v.xy()
            + v.s() * x.z() * v.yz()
            - v.yz() * x.x() * v.xz()
...
pub fn sandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        ...
        v.xz() * x.xy() * v.xy()
            ...
            - v.yz() * x.xy() * v.s()
            - v.yz() * x.xz() * v.yz(),
        -(v.s() * x.xz() * v.xy()) + v.s() * x.yz() * v.s() - v.xy() * x.xz() * v.s()
            + v.xy() * x.xy() * v.yz()
            + v.xz() * x.xy() * v.s()
            - v.xz() * x.yz() * v.xz()
            + v.yz() * x.xy() * v.xy()
...
pub fn sandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new_unchecked(
        -(v.yz() * x.xy() * v.xz()) + v.xy() * x.yz() * v.xz() + v.xz() * x.xy() * v.yz()
            - v.xz() * x.xz() * v.s()
            - v.xz() * x.yz() * v.xy()
            + v.s() * x.xy() * v.xy()
            + v.xz() * x.s() * v.xz()
            ...
            + v.s() * x.xz() * v.xz()
            - v.xy() * x.xy() * v.s(),
        v.xz() * x.xz() * v.xy() - v.s() * x.yz() * v.xz() - v.yz() * x.xy() * v.yz()
            + v.xy() * x.s() * v.s()
            + v.s() * x.xz() * v.yz()
            + v.s() * x.xy() * v.s()
            + v.yz() * x.xz() * v.s()
            ...
            + v.xy() * x.xz() * v.xz()
            + v.yz() * x.yz() * v.xy(),
        -(v.s() * x.xy() * v.yz()) + v.xz() * x.yz() * v.yz() - v.yz() * x.xz() * v.yz()
            + v.yz() * x.s() * v.xy()
            + v.yz() * x.yz() * v.xz()
            - v.yz() * x.xy() * v.s()
            + v.s() * x.yz() * v.xy()
