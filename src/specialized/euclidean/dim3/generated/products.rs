...
pub fn sandwich_rotor_vector<T: Float>(v: &Rotor<T>, x: &Vector<T>) -> Vector<T> {
    Vector::new(
        v.yz() * x.z() * v.xy() + v.yz() * x.x() * v.yz() + v.xy() * x.z() * v.yz()
            - v.xz() * x.y() * v.yz()
            - v.yz() * x.y() * v.xz()
            + v.s() * x.y() * v.xy()
            + v.s() * x.x() * v.s()
...
pub fn sandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        v.xy() * x.xz() * v.xz() - v.xz() * x.yz() * v.s() + v.yz() * x.xz() * v.s()
            - v.xz() * x.xy() * v.xz()
            + v.xy() * x.yz() * v.yz()
            + v.s() * x.xy() * v.s()
            + v.s() * x.xz() * v.yz()
...
pub fn sandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        ...
        v.s() * x.xz() * v.yz() - v.s() * x.yz() * v.xz()
            ...
            + v.yz() * x.yz() * v.xy()
            - v.s() * x.s() * v.xy(),
        v.xy() * x.yz() * v.s() - v.s() * x.s() * v.xz() - v.s() * x.xy() * v.yz()
            + v.s() * x.yz() * v.xy()
            - v.xy() * x.s() * v.yz()
            + v.xz() * x.xy() * v.xy()
            - v.yz() * x.xz() * v.yz()
...
pub fn antisandwich_rotor_bivector<T: Float>(v: &Rotor<T>, x: &Bivector<T>) -> Bivector<T> {
    Bivector::new(
        v.xz() * x.yz() * v.s() - v.yz() * x.xy() * v.yz()
            ...
            + v.yz() * x.yz() * v.xy()
            + v.xy() * x.yz() * v.yz(),
        v.s() * x.xy() * v.yz() - v.xy() * x.xz() * v.xy() + v.xy() * x.xy() * v.xz()
            - v.s() * x.yz() * v.xy()
            + v.xz() * x.xy() * v.xy()
            + v.yz() * x.xy() * v.s()
            + v.s() * x.xz() * v.s()
            ...
            + v.xz() * x.xz() * v.xz()
            + v.xz() * x.yz() * v.yz(),
        -(v.xz() * x.xy() * v.s()) - v.xz() * x.yz() * v.xz() - v.s() * x.xy() * v.xz()
            + v.xy() * x.xz() * v.s()
            - v.xy() * x.yz() * v.xy()
            + v.xy() * x.xy() * v.yz()
            + v.yz() * x.xz() * v.xz()
...
pub fn antisandwich_rotor_rotor<T: Float>(v: &Rotor<T>, x: &Rotor<T>) -> Rotor<T> {
    Rotor::new(
        v.xz() * x.yz() * v.xy()
            ...
            + v.s() * x.xy() * v.xy()
            - v.yz() * x.yz() * v.s(),
        v.xy() * x.xy() * v.xy() + v.xy() * x.xz() * v.xz() + v.yz() * x.s() * v.xz()
            - v.s() * x.s() * v.xy()
            - v.yz() * x.xy() * v.yz()
            + v.s() * x.xy() * v.s()
            - v.xz() * x.s() * v.yz()
