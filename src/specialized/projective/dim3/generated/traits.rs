...
mod verification_tests {
    ...
    proptest! {
        #[test]
        fn sandwich_flector_point_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Point<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Motor<f64> = geometric_flector_point(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Flector<f64> = geometric_motor_flector(&vx, &v_rev);

            // Combined formula
            let combined: Point<f64> = sandwich_flector_point(&v, &x);

            // Convert to Multivector for comparison (handles different output types)
            let stepwise_mv: Multivector<f64, Projective3> = stepwise.into();
            let combined_mv: Multivector<f64, Projective3> = combined.into();
    ...
    proptest! {
        #[test]
        fn sandwich_flector_line_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Line<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Flector<f64> = geometric_flector_line(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Motor<f64> = geometric_flector_flector(&vx, &v_rev);

            // Combined formula
            let combined: Line<f64> = sandwich_flector_line(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_flector_plane_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Plane<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Motor<f64> = geometric_flector_plane(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Flector<f64> = geometric_motor_flector(&vx, &v_rev);

            // Combined formula
            let combined: Plane<f64> = sandwich_flector_plane(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_flector_motor_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Motor<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Flector<f64> = geometric_flector_motor(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Motor<f64> = geometric_flector_flector(&vx, &v_rev);

            // Combined formula
            let combined: Motor<f64> = sandwich_flector_motor(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_flector_flector_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Flector<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Motor<f64> = geometric_flector_flector(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Flector<f64> = geometric_motor_flector(&vx, &v_rev);

            // Combined formula
            let combined: Flector<f64> = sandwich_flector_flector(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_motor_point_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Point<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Flector<f64> = geometric_motor_point(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Flector<f64> = geometric_flector_motor(&vx, &v_rev);

            // Combined formula
            let combined: Point<f64> = sandwich_motor_point(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_motor_line_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Line<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Motor<f64> = geometric_motor_line(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Motor<f64> = geometric_motor_motor(&vx, &v_rev);

            // Combined formula
            let combined: Line<f64> = sandwich_motor_line(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_motor_plane_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Plane<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Flector<f64> = geometric_motor_plane(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Flector<f64> = geometric_flector_motor(&vx, &v_rev);

            // Combined formula
            let combined: Plane<f64> = sandwich_motor_plane(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_motor_motor_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Motor<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Motor<f64> = geometric_motor_motor(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Motor<f64> = geometric_motor_motor(&vx, &v_rev);

            // Combined formula
            let combined: Motor<f64> = sandwich_motor_motor(&v, &x);
    ...
    proptest! {
        #[test]
        fn sandwich_motor_flector_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Flector<f64>>()
        ) {
            // Stepwise: v * x * rev(v)
            let vx: Flector<f64> = geometric_motor_flector(&v, &x);
            let v_rev = v.reverse();
            let stepwise: Flector<f64> = geometric_flector_motor(&vx, &v_rev);

            // Combined formula
            let combined: Flector<f64> = sandwich_motor_flector(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_flector_point_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Point<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Motor<f64> = antigeometric_flector_point(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Flector<f64> = antigeometric_motor_flector(&vx, &v_antirev);

            // Combined formula
            let combined: Point<f64> = antisandwich_flector_point(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_flector_line_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Line<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Flector<f64> = antigeometric_flector_line(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Motor<f64> = antigeometric_flector_flector(&vx, &v_antirev);

            // Combined formula
            let combined: Line<f64> = antisandwich_flector_line(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_flector_plane_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Plane<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Motor<f64> = antigeometric_flector_plane(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Flector<f64> = antigeometric_motor_flector(&vx, &v_antirev);

            // Combined formula
            let combined: Plane<f64> = antisandwich_flector_plane(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_flector_motor_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Motor<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Flector<f64> = antigeometric_flector_motor(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Motor<f64> = antigeometric_flector_flector(&vx, &v_antirev);

            // Combined formula
            let combined: Motor<f64> = antisandwich_flector_motor(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_flector_flector_stepwise_equals_combined(
            v in any::<Flector<f64>>(),
            x in any::<Flector<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Motor<f64> = antigeometric_flector_flector(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Flector<f64> = antigeometric_motor_flector(&vx, &v_antirev);

            // Combined formula
            let combined: Flector<f64> = antisandwich_flector_flector(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_motor_point_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Point<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Flector<f64> = antigeometric_motor_point(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Flector<f64> = antigeometric_flector_motor(&vx, &v_antirev);

            // Combined formula
            let combined: Point<f64> = antisandwich_motor_point(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_motor_line_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Line<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Motor<f64> = antigeometric_motor_line(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Motor<f64> = antigeometric_motor_motor(&vx, &v_antirev);

            // Combined formula
            let combined: Line<f64> = antisandwich_motor_line(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_motor_plane_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Plane<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Flector<f64> = antigeometric_motor_plane(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Flector<f64> = antigeometric_flector_motor(&vx, &v_antirev);

            // Combined formula
            let combined: Plane<f64> = antisandwich_motor_plane(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_motor_motor_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Motor<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Motor<f64> = antigeometric_motor_motor(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Motor<f64> = antigeometric_motor_motor(&vx, &v_antirev);

            // Combined formula
            let combined: Motor<f64> = antisandwich_motor_motor(&v, &x);
    ...
    proptest! {
        #[test]
        fn antisandwich_motor_flector_stepwise_equals_combined(
            v in any::<Motor<f64>>(),
            x in any::<Flector<f64>>()
        ) {
            // Stepwise: v ⊛ x ⊛ antirev(v)
            let vx: Flector<f64> = antigeometric_motor_flector(&v, &x);
            let v_antirev = v.antireverse();
            let stepwise: Flector<f64> = antigeometric_flector_motor(&vx, &v_antirev);

            // Combined formula
            let combined: Flector<f64> = antisandwich_motor_flector(&v, &x);
