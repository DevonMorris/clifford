...
impl<T: Float> Mul<Flector<T>> for Line<T> {
    ...
    fn mul(self, rhs: Flector<T>) -> Flector<T> {
        Flector::new_unchecked(
            -(self.e23() * rhs.e123()) + self.e31() * rhs.e3() + self.e12() * rhs.e2(),
            self.e23() * rhs.e3() + self.e31() * rhs.e123() + -(self.e12() * rhs.e1()),
            -(self.e23() * rhs.e2()) + -(self.e31() * rhs.e1()) + -(self.e12() * rhs.e123()),
            -(self.e01() * rhs.e1())
                + -(self.e02() * rhs.e2())
                + -(self.e03() * rhs.e3())
                + -(self.e23() * rhs.e023())
            ...
            -(self.e01() * rhs.e2())
                ...
                + -(self.e31() * rhs.e023())
                + self.e12() * rhs.e0(),
            self.e23() * rhs.e1() + -(self.e31() * rhs.e2()) + self.e12() * rhs.e3(),
        )
    }
}
impl<T: Float> Mul<Line<T>> for Line<T> {
    ...
    fn mul(self, rhs: Line<T>) -> Motor<T> {
        Motor::new_unchecked(
            ...
            self.e31() * rhs.e12() + -(self.e12() * rhs.e31()),
            -(self.e23() * rhs.e12()) + self.e12() * rhs.e23(),
...
impl<T: Float> Mul<Motor<T>> for Line<T> {
    ...
    fn mul(self, rhs: Motor<T>) -> Motor<T> {
        Motor::new_unchecked(
            -(self.e23() * rhs.e23()) + -(self.e31() * rhs.e31()) + -(self.e12() * rhs.e12()),
            self.e23() * rhs.s() + self.e31() * rhs.e12() + -(self.e12() * rhs.e31()),
            -(self.e23() * rhs.e12()) + self.e31() * rhs.s() + self.e12() * rhs.e23(),
            self.e23() * rhs.e31() + -(self.e31() * rhs.e23()) + self.e12() * rhs.s(),
            self.e01() * rhs.s()
                + -(self.e02() * rhs.e12())
                + -(self.e03() * rhs.e31())
                + -(self.e23() * rhs.e0123())
...
impl<T: Float> Mul<Plane<T>> for Line<T> {
    ...
    fn mul(self, rhs: Plane<T>) -> Flector<T> {
        Flector::new_unchecked(
            ...
            self.e31() * rhs.e123(),
            -(self.e12() * rhs.e123()),
            -(self.e23() * rhs.e023()) + -(self.e31() * rhs.e031()) + -(self.e12() * rhs.e012()),
...
impl<T: Float> Mul<Line<T>> for Motor<T> {
    ...
    fn mul(self, rhs: Line<T>) -> Motor<T> {
        Motor::new_unchecked(
            -(self.e23() * rhs.e23()) + -(self.e31() * rhs.e31()) + -(self.e12() * rhs.e12()),
            self.e31() * rhs.e12() + -(self.e12() * rhs.e31()) + self.s() * rhs.e23(),
            -(self.e23() * rhs.e12()) + self.e12() * rhs.e23() + self.s() * rhs.e31(),
            self.e23() * rhs.e31() + -(self.e31() * rhs.e23()) + self.s() * rhs.e12(),
            -(self.e02() * rhs.e12())
                + -(self.e03() * rhs.e31())
                + self.e31() * rhs.e03()
                + self.e12() * rhs.e02()
...
impl<T: Float> Mul<Point<T>> for Motor<T> {
    ...
    fn mul(self, rhs: Point<T>) -> Flector<T> {
        Flector::new_unchecked(
            self.e31() * rhs.e3() + self.e12() * rhs.e2() + self.s() * rhs.e1(),
            self.e23() * rhs.e3() + -(self.e12() * rhs.e1()) + self.s() * rhs.e2(),
            -(self.e23() * rhs.e2()) + -(self.e31() * rhs.e1()) + self.s() * rhs.e3(),
            -(self.e01() * rhs.e1())
                + -(self.e02() * rhs.e2())
                + -(self.e03() * rhs.e3())
                + self.s() * rhs.e0(),
...
impl<T: Float> Antiwedge<Plane<T>> for Line<T> {
    ...
    fn antiwedge(&self, rhs: &Plane<T>) -> Point<T> {
        Point::new(
            ...
            -(self.e02() * rhs.e123()) + self.e23() * rhs.e012() + -(self.e12() * rhs.e023()),
            -(self.e03() * rhs.e123()) + self.e23() * rhs.e031() + -(self.e31() * rhs.e023()),
            -(self.e01() * rhs.e023()) + self.e02() * rhs.e031() + -(self.e03() * rhs.e012()),
        )
    }
}
