...
mod tests {
    ...
    proptest! {
        ...
        fn inverse_matches_nalgebra(
            ...
            prop_assert!(abs_diff_eq!(pga_back.x(), na_back.x, epsilon = RELATIVE_EQ_EPS));
            prop_assert!(abs_diff_eq!(pga_back.y(), na_back.y, epsilon = RELATIVE_EQ_EPS));
            prop_assert!(abs_diff_eq!(pga_back.x(), px, epsilon = RELATIVE_EQ_EPS));
            prop_assert!(abs_diff_eq!(pga_back.y(), py, epsilon = RELATIVE_EQ_EPS));
        }
    ...
    fn identity_motor_matches_nalgebra_identity() {
        ...
        for (px, py) in points {
            ...
            assert!(abs_diff_eq!(pga_result.x(), px, epsilon = RELATIVE_EQ_EPS));
            assert!(abs_diff_eq!(pga_result.y(), py, epsilon = RELATIVE_EQ_EPS));
        }
    }
    ...
    fn identity_motor_to_unitcomplex() {
        ...
        assert!(abs_diff_eq!(uc.re, 1.0, epsilon = RELATIVE_EQ_EPS));
        assert!(abs_diff_eq!(uc.im, 0.0, epsilon = RELATIVE_EQ_EPS));
    }
