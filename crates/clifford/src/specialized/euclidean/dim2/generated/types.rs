...
impl<T: Float> Bivector<T> {
    ...
    #[inline]
    pub fn new_unchecked(b: T) -> Self {
        Self::new(b)
    }
    #[doc = "Returns the `b` coefficient."]
    #[inline]
    pub fn b(&self) -> T {
        self.b
    }
...
impl<T: Float> Rotor<T> {
    ...
    #[doc = r" used in performance-critical code or trusted contexts."]
    #[inline]
    pub fn new_unchecked(s: T, b: T) -> Self {
        Self::new(s, b)
    }
    ...
    #[inline]
    pub fn scale(&self, s: T) -> Self {
        Self::new_unchecked(self.s * s, self.b * s)
    }
    #[doc = r" Returns the reverse (reversion)."]
    #[doc = r""]
    #[doc = r" For a k-blade, the reverse has sign (-1)^(k(k-1)/2):"]
